# <img src="./.github/assets/prettier.svg" width="40" align="left" alt="">  `pnpm add @brlt/prettier@1.8.1`
...
```sh
pnpm add -D @brlt/prettier@1.8.1 # overrides may change w/o notice. pin the version!
```

```sh
yarn add --dev @brlt/prettier@1.8.1
```

```sh
npm i -D @brlt/prettier@1.8.1
```
